...
<div class="d-flex justify-content-between align-items-center">
    <h1 class="m-0 text-dark" style="font-size:1.3rem;">
        <i class="fas fa-map-marker-alt mr-2" style="color:#7c3aed;"></i>Nueva Área / Espacio
    </h1>
        ...
        <div class="card card-outline card-primary">
            <div class="card-header py-2">
                <h6 class="mb-0 font-weight-bold">
                    <i class="fas fa-plus-circle mr-1 text-primary"></i> Datos del área
                </h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('areas.store') }}">
                    @csrf
                    {{-- Preservar popup origin --}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('name') }}"
                               placeholder="Ej: Sala de reuniones A, Almacén central..."
                               required>
                        @error('name')
                    ...
                    <div class="form-group mb-0">
                        ...
                        <textarea name="description"
                                  ...
                                  placeholder="Ubicación, capacidad u otras observaciones...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>

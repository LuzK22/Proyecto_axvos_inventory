    ...
    <div class="col-lg-8">
            ...
            <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">
                                ...
                                <i class="fas fa-question-circle text-muted" style="font-size:.8rem;"
                                   data-toggle="tooltip" title="Sticker físico pegado al equipo para inventario presencial. Ej: INV-0042"></i>
                            </label>
                ...
                <div class="form-group mb-0">
                    <label class="font-weight-bold">
                        Código Activo Fijo
                        <i class="fas fa-question-circle text-muted" style="font-size:.8rem;"
                           data-toggle="tooltip" title="Número asignado por Contabilidad para cruce con sistema contable (SAP, Siigo, etc.)"></i>
                    </label>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="form-group" id="provider_row" style="{{ in_array(old('property_type'), ['LEASING','ALQUILADO']) ? '' : 'display:none;' }}">
                    <label class="font-weight-bold">

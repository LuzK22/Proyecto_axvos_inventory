        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="hub-btn hub-btn-soon">
                    ...
                    <div class="hub-btn-text"><strong>Historial de Préstamos</strong><small>Préstamos finalizados</small></div>
                    <span class="hub-soon-badge">Próximamente</span>
                </div>
            </div>
...
<div class="card shadow-sm">
    <div class="card-body">
        <p class="hub-section-title"><i class="fas fa-file-signature mr-1"></i> Actas</p>
        <div class="row">

            <div class="col-md-4 mb-3">
                <div class="hub-btn hub-btn-soon">
                    <div class="hub-btn-icon"><i class="fas fa-file-alt"></i></div>
                    <div class="hub-btn-text"><strong>Acta de Préstamo</strong><small>Generar acta en PDF</small></div>
                    <span class="hub-soon-badge">Próximamente</span>
                </div>
            </div>

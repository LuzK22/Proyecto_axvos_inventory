...
@section('title', 'Nueva Solicitud de Baja — Otros Activos')

@section('content_header')
<div class="d-flex justify-content-between align-items-center">
    <div>
        <h1 class="m-0 text-dark">
            <i class="fas fa-file-medical-alt mr-2 text-danger"></i> Nueva Solicitud de Baja — Otros Activos
        </h1>
        <small class="text-muted">Selecciona el activo y completa la justificación. Quedará pendiente de aprobación.</small>
    </div>
    <a href="{{ route('assets.disposals.index') }}" class="btn btn-secondary btn-sm">
        ...
        <div class="card shadow-sm mb-3">
            <div class="card-header py-2" style="border-left:4px solid #991b1b;">
                <h6 class="mb-0 font-weight-bold">
                    <i class="fas fa-boxes mr-1 text-danger"></i>
                    Seleccionar Activo General (OTRO)
                </h6>
            </div>
            <div class="card-body">
                <input type="text" id="assetSearch" class="form-control form-control-sm mb-2"
                       placeholder="Buscar por código, tipo, nombre, serial...">

                @if($assets->isEmpty())
                <div class="alert alert-info mb-0">
                    <i class="fas fa-info-circle mr-1"></i>
                    No hay Otros Activos disponibles para solicitar baja.
                </div>
                @else
                ...
                <form id="requestForm" method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <select name="reason" class="form-control" required>
                            ...
                            <option value="obsoleto">Obsoleto / Depreciado</option>
                    ...
                    <div class="form-group mb-0">
                        ...
                        <small class="text-muted">Esta información llegará al aprobador.</small>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="card shadow-sm mt-3 border-left-warning">
            <div class="card-body py-2 px-3">
                ...
                <div id="assetSummary" class="text-muted small">
                    <i class="fas fa-mouse-pointer mr-1"></i> Haz clic en un activo
                </div>
            </div>
        </div>
    </div>
...
function selectAsset(row) {
    ...
    document.getElementById('assetSummary').innerHTML =
        '<i class="fas fa-box mr-1 text-danger"></i><strong>' + code + '</strong>';
}
